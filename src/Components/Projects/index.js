...
function Projects() {
  const [photos] = useState([
    {
      name: "Dream Notes",
      description: "Application which allows users to login and track their dreams.",
      url: "https://dream-notes-app.herokuapp.com/",
      gitRepo: "https://github.com/jessica-calderon/dream-notes",
    },
    {
      name: "Pet Portal",
      description:
        "A functional application designed for pet care providers to log in and track various actions utilizing and SQL database.  This dual function app also allows pet owners to view log in and view appointment, pet information, and communicate with pet care staff.",
    ...
    },
    {
      name: "Event Radar",
      description:
        "An interactive application that returns the event and weather information base on user request",
    ...
    },
    {
      name: "Note Taker",
      description:
        "Personal app designed to allow users to take and save quick notes",
